...
update_date <- as.POSIXct(update_date)
update_date <- format(update_date, tz = "Australia/Melbourne")
```

The last time the script was run to check for new data was `r ref_date` Melbourne time. 

The last time new data was found was `r update_date` Melbourne time.
